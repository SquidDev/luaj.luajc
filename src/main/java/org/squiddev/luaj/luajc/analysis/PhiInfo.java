...
public final class PhiInfo extends VarInfo {
	...
	/**
	 * Gets a list values that this is defined as
	 *
	 * @return The list of values
	 * @see #resolvePhiVariableValues()
	 */
	public Set<VarInfo> values() {
		return values;
	}

	@Override
	public boolean contains(VarInfo other) {
		return super.contains(other) || values.contains(other);
	}
